...
fn main() {
    ...
    vote_weights.insert(
        "bcb_1stofnrxuz3cai7ze75o174bpm7scwj9jn3nxsn8ntzg784jf1gzn1jjdkou"
            .parse()
            .unwrap(),
        1,
    );
    vote_weights.insert(
        "bcb_1q3hqecaw15cjt7thbtxu3pbzr1eihtzzpzxguoc37bj1wc5ffoh7w74gi6p"
            .parse()
            .unwrap(),
        1,
    );
    vote_weights.insert(
        "bcb_3dmtrrws3pocycmbqwawk6xs7446qxa36fcncush4s1pejk16ksbmakis78m"
            .parse()
            .unwrap(),
        1,
    );
    vote_weights.insert(
        "bcb_3hd4ezdgsp15iemx7h81in7xz5tpxi43b6b41zn3qmwiuypankocw3awes5k"
            .parse()
            .unwrap(),
        1,
    );
    vote_weights.insert(
        "bcb_1awsn43we17c1oshdru4azeqjz9wii41dy8npubm4rg11so7dx3jtqgoeahy"
            .parse()
            .unwrap(),
        1,
    );
